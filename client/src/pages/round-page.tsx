...
import type { MatchWithDetails, Round, TeamWithStandings } from "@shared/schema";
...
export default function RoundPage() {
  ...
  // Calculate round points for each team
  const roundPoints = teams.map(team => {
      ...
      <main className="max-w-md mx-auto pb-20">
        ...
        <section className="px-4 py-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <Badge className={`ml-auto ${getStatusColor(round.status)} text-white`}>
        ...
        <section className="px-4 mb-6">
          <h2 className="font-semibold text-xl mb-4">Round {round.number} Standings</h2>
                    ...
                    <div className={`flex items-center justify-between ${
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-300">{team.captain}</p>
                        </div>
                      </div>
                      <div className="text-right">
                        ...
                        <div className="text-xs text-gray-300">Round Points</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
        ...
        {/* Round Matches */}
        <section className="px-4 mb-6">
          <h2 className="font-semibold text-xl mb-4">Round {round.number} Matches</h2>
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex items-center justify-between mb-2 p-2 bg-blue-600/20 rounded-lg">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="font-medium text-sm">{match.team1.name}</p>
                        ...
                        <div className="text-right">
                          <div className="font-mono font-bold">{match.team1Score}</div>
                          {match.team1Status && (
                      ...
                      <div className="flex items-center justify-between p-2 bg-red-600/20 rounded-lg">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="font-medium text-sm">{match.team2.name}</p>
                            <p className="text-xs text-gray-300">
                              {match.matchPlayers
                        ...
                        <div className="text-right">
                          <div className="font-mono font-bold">{match.team2Score}</div>
                          {match.team2Status && (
                            <div className={`text-xs ${
