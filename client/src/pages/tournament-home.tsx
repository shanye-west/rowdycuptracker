            ...
            {rounds.length === 0 ? (
              <Card className="glass-effect border-white/20 bg-transparent">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-300">Tournament rounds will be posted soon.</p>
                </CardContent>
              </Card>
            ) : (
              rounds.map((round) => (
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex-1">
                          <div className="flex items-center space-x-3 mb-2">
                            <h3 className="font-bold text-lg">Round {round.number}</h3>
                          ...
                          <div className="text-sm text-gray-300 space-y-1">
                            <p><span className="font-medium">Format:</span> {round.format}</p>
                            {round.teeTime && <p><span className="font-medium">Tee Times:</span> {round.teeTime}</p>}
                            {round.date && (
                              <p><span className="font-medium">Date:</span> {new Date(round.date).toLocaleDateString()}</p>
                            )}
                          </div>
                        </div>
